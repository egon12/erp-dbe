	...
	jQuery(document).ready(function($){
		...
		$('input#age').on('change', function(){
			...
			if (age_now != '') {
				...
				temp['month'] = '01'; //supaya ketahuan mana yang udah dimasukin beneran dan mana yang belum
				temp['day'] = '01';
...
<?php echo form_open("customer/add");?>
	<fieldset>
		<div class="widget">
			...
			<div class="formRow">
	            <div class="grid3"><?php echo lang('add_address_label', 'address');?></div>
			...
			<div class="formRow">
	            <div class="grid3"><?php echo lang('add_birth_place_label', 'birth_place');?></div>
	            <div class="grid9"><?php echo form_input($data['birth_place']);?></div>
				<div class="clear"></div>
	        </div>
			<div class="formRow">
	            <div class="grid3"><?php echo lang('add_age_label', 'age');?></label></div>
	            <div class="grid9"><?php echo form_input($data['age']);?></div>
				<div class="clear"></div>
	        </div>
			<div class="formRow">
	            <div class="grid3"><label><?php echo lang('add_birth_date_label');?><span class="req">*</span></label></div>
            ...
            <div class="formRow">
                <div class="formSubmit">
                    <?php echo form_submit('submit', lang('add_submit_btn'), 'class="buttonM bBlue mr10"');?>
