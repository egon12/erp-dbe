<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		var myTable = $('.dTable').dataTable({
			...
			"aoColumns":[
				{"mDataProp": "code",  "sType": "numeric"},
		        {"mDataProp": "name",  "sType": "natural"},
		        {"mDataProp": "price", "sType": "numeric", "sClass": "align-right"},
		        {"mDataProp": "description", "sType": "natural"},
...
<div class="widget">
	<div class="whead">
        ...
        <a href="<?php echo site_url('product/add') ?>" class="buttonS bGreen formSubmit">Add Product</a>
		<div class="clear"></div>
	</div>
	<div class="shownpars">
